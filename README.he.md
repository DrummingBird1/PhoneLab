...
**📡 טאב חיישנים** — קריאות חיות מ-כ-29 חיישנים (מד תאוצה, ג'ירוסקופ, מגנטומטר, כוח כבידה, וקטורי סיבוב, ברומטר, תאורה, קרבה, לחות, טמפרטורת סביבה, דופק, מונה צעדים, גלאי הטיה ותנועה ועוד), בנוסף למהירות GPS ומד רמת קול חי. זמינות החיישנים תלויה במכשיר — האפליקציה מסמנת בבירור מה לא קיים בחומרה שלכם.
